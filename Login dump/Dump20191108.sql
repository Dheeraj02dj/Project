...
--
-- Table structure for table `logindeat`
--

DROP TABLE IF EXISTS `logindeat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `logindeat` (
...
--
-- Dumping data for table `logindeat`
--

LOCK TABLES `logindeat` WRITE;
/*!40000 ALTER TABLE `logindeat` DISABLE KEYS */;
INSERT INTO `logindeat` VALUES ('bce','bce123@'),('darsh','drshn'),('dhe','dhe123'),('shubham','shubhamg');
/*!40000 ALTER TABLE `logindeat` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-08 20:27:05
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
